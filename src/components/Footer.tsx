      ...
      >
        <div className="container px-3 md:px-4 py-8 md:py-12">
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 md:gap-8">
            ...
            >
              <h3
                className="text-base md:text-lg font-bold text-foreground mb-2 md:mb-3"
                itemProp="name"
              >
                Mahimsky
              </h3>
              ...
              >
                A digital platform by Mahimsky – building sustainable online
                assets and resources for earning on the web.
              </p>
              <meta itemProp="url" content="https://mahimsky.online" />
            </div>
          ...
          <div className="mt-6 md:mt-10 pt-4 md:pt-6 border-t border-border">
            <p className="text-center text-[10px] md:text-xs text-muted-foreground">
              © {currentYear} Mahimsky. All rights reserved. |{" "}
